    ...
    <div class="container">
        ...
        <div class="content">
            @foreach ($lates as $item)
                ...
                <p>Rombel: {{ $item->student->rombel->rombel }}</p>
                <p>Rayon: {{ $item->student->rayon->rayon }}</p>
            @endforeach
        </div>

        <p>Dengan ini menyatakan bahwa saya telah melakukan pelanggaran tata tertib sekolah, yaitu terlambat datang ke
            sekolah sebanyak <strong>{{ $totallate }}</strong> kali yang mana hal tersebut termasuk kedalam pelanggaran kedisiplinan.
